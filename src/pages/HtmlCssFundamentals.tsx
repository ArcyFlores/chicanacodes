        ...
        <div className="pt-20">
          ...
          <div className="text-center mb-16">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-green-400 to-emerald-500 text-slate-900 font-bold px-8 py-3 hover:shadow-lg hover:shadow-green-400/25 transition-all duration-300"
            >
